...
<!-- page-wrapper  start -->
		...
		<div class="row">
            <div class="col-lg-12">
                <h3 class="page-header text-primary">上传图片管理
                	<button type="button" class="btn btn-outline btn-primary btn-sm pull-right"  onclick="toPage(this, '/upload/toImgEdit', { operatType: '0' })" >添加图片</button>
                </h3>
            </div>
            <!-- /.col-lg-12 -->
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                            <ol class="breadcrumb">
                                <li><a href="">上传管理</a></li>
                                <li><a href="#" onclick="toPage(this, '/toUser', '')">上传图片管理</a></li>
                            </ol>
                        <!-- /.panel-heading -->
