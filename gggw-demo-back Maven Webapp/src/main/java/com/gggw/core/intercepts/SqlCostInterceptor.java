package com.gggw.core.intercepts;
...
/**
 * Created by cuigaowei on 2017/6/25.
 */
...
public class SqlCostInterceptor implements Interceptor {
    ...
    private static org.slf4j.Logger logger = LoggerFactory.getLogger(SqlCostInterceptor.class);
     ...
     * @return
     */
    private final String formatSql(String sql, Object parameterObject,  List<ParameterMapping> parameterMappingList) {
        //判断是否为空
     ...
     * @return
     */
    private final String beautifySql(String sql) {
