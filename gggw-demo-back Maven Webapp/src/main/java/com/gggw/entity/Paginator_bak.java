 ...
 * @author cgw
 */
public class Paginator_bak implements java.io.Serializable {
	...
	public Paginator_bak(int pageNum, int pageSize, int recordsTotal, int recordsFiltered, Object data, int draw) {
		super();
...
//	}
	...
	public static void main(String[] args) {
		...
		Paginator_bak paginator = new Paginator_bak(10, 20, 5, 5, bs, 1);
